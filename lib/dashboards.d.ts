...
export declare let create: (userId: ObjectID, name: string, cb: common.ErrorCallback) => void;
export declare let updateMetadata: (userId: string, dashboardId: string, metadataType: MetadataType, sourceName: string, data: any, cb: common.ErrorCallback) => void;
